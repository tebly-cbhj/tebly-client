...
const OptionText = styled.span`
  ${({ $selected, theme }) => $selected ? theme.typography.s2 : theme.typography.body2};
...
export default function RepeatEndPopup({ selected = '안 함', onClose, onSelect }) {
  return (
      ...
      <Sheet onClick={(e) => e.stopPropagation()}>
        ...
        <OptionList>
          {END_OPTIONS.map((option) => {
            ...
            return (
              <OptionRow key={option} type="button" onClick={() => onSelect?.(option)}>
